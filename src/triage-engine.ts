      ...
      items: {
        ...
        properties: {
          ...
          category: {
            type: "STRING",
            enum: ["high", "low"],
            description: "high: 関心・スキルに関連がある。迷ったらhigh。low: 明らかに領域外",
          },
...
3. 各Inboxアイテムについて、このユーザーに関係あるかをhigh/lowで判定する
   highの基準（いずれか1つでも当てはまればhigh）:
   - 今の作業や関心に関連する技術・ツール・概念を扱っている
   - ユーザーのスキルセットや興味の延長線上にある
   - 知っておくと今後の判断や作業に役立つ可能性がある
   lowの基準: ユーザーの技術領域・関心から明らかに外れている
   迷ったらhighにする。全体の20-40%程度がhighになるのが目安
</instructions>
